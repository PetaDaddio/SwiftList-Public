 ...
 * - Server-side credit calculation (prevents client manipulation)
 * - Atomic database operations
 * - Automatic credit refund on queue failure
 */
...
const log = jobsLogger.child({ route: 'api/jobs/submit' });
...
export const POST: RequestHandler = async ({ request, locals }) => {
	...
	// The RPC uses SELECT ... FOR UPDATE to lock the row and verify balance >= amount
